    ...
    return (
        <div className="space-y-12 py-8 flex flex-col items-center">
            <div className="text-center mb-12">
                <h3 className="text-4xl font-black uppercase tracking-[0.15em] text-sor7ed-yellow mb-2">Routine Architect</h3>
            ...
            <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="stealth-card p-8 space-y-8">
                    <h4 className="text-[10px] font-mono-headline text-zinc-500 uppercase tracking-[0.15em] border-b border-white/5 pb-4">Activity Palette</h4>
                ...
                <div className="stealth-card p-8 space-y-8 bg-sor7ed-yellow/[0.02]">
                    <h4 className="text-[10px] font-mono-headline text-sor7ed-yellow uppercase tracking-[0.15em] border-b border-sor7ed-yellow/10 pb-4">Active Protocol Timeline</h4>
                    <div className="space-y-4 min-h-[300px]">
                        {routine.length > 0 ? routine.map((item: any, i) => (
                            ...
                            >
                                ...
                                <div className="flex-grow text-[11px] font-bold uppercase tracking-[0.15em] text-white">{item.text}</div>
                                <button
                            ...
                            <div className="h-full flex flex-col items-center justify-center space-y-4 py-20 grayscale opacity-20">
                                ...
                                <p className="text-[9px] font-mono-headline uppercase tracking-[0.15em]">Awaiting Sequence Input</p>
                            </div>
                        )}
                    </div>
                    ...
                    {routine.length > 0 && (
                        <button
                            onClick={() => setRoutine([])}
                            className="w-full py-4 text-[9px] font-mono-headline text-zinc-600 hover:text-white uppercase tracking-[0.15em] transition-colors"
                        >
                            [ Clear Architecture ]
                        </button>
                    )}
